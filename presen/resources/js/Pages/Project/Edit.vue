<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="c-siteView p-edit">
            <form @submit.prevent="updateProject" class="c-form p-pjForm">

                <div class="p-p-pjForm__container">
                ...
                <div class="p-pjForm__container">
                    <label class="c-label p-pjForm__label" for="type">プロジェクトの種類 *</label>
                    <select v-model="form.type" name="type" id="type" class="c-select p-pjForm__select" required>
                ...
                <div class="p-pjForm__submit">
                    <input class="c-submit p-pjForm__submit" type="submit" :disabled="form.processing" value="更新して保存">
                </div>

                <form class="c-form p-pjDelete" @submit.prevent="deleteProject">
                    <input type="submit" value="　削除する　" class="c-submit p-pjDelete__submit">
                </form>
